...
class breptools:
	...
	@staticmethod
	def Dump(Sh: TopoDS_Shape) -> Standard_OStream: ...
	@staticmethod
	...
	@overload
	@staticmethod
	def Read(Sh: TopoDS_Shape, S: Standard_IStream, B: BRep_Builder, PR: Optional[Message_ProgressIndicator] = None) -> None: ...
	@overload
	@staticmethod
	...
	@overload
	@staticmethod
	def Write(Sh: TopoDS_Shape, PR: Optional[Message_ProgressIndicator] = None) -> Standard_OStream: ...
	@overload
	@staticmethod
...
class BRepTools_ShapeSet(TopTools_ShapeSet):
	...
	def Clear(self) -> None: ...
	@overload
	def DumpGeometry(self) -> Standard_OStream: ...
	@overload
	def DumpGeometry(self, S: TopoDS_Shape) -> Standard_OStream: ...
	def DumpPolygon3D(self) -> Standard_OStream: ...
	def DumpPolygonOnTriangulation(self) -> Standard_OStream: ...
	def DumpTriangulation(self) -> Standard_OStream: ...
	@overload
	...
	def WritePolygon3D(self, Compact: Optional[bool] = True) -> Standard_OStream: ...
	def WritePolygonOnTriangulation(self, Compact: Optional[bool] = True) -> Standard_OStream: ...
	def WriteTriangulation(self, Compact: Optional[bool] = True) -> Standard_OStream: ...
