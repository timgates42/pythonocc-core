...
class BinDrivers_DocumentRetrievalDriver(BinLDrivers_DocumentRetrievalDriver):
	...
	def CheckShapeSection(self, thePos: Storage_Position, theIS: Standard_IStream) -> None: ...
	def Clear(self) -> None: ...
	def ReadShapeSection(self, theSection: BinLDrivers_DocumentSection, theIS: Standard_IStream, isMess: Optional[bool] = False) -> None: ...
...
class BinDrivers_DocumentStorageDriver(BinLDrivers_DocumentStorageDriver):
	...
	def WriteShapeSection(self, theDocSection: BinLDrivers_DocumentSection) -> Standard_OStream: ...
