...
class topopebrep:
	@staticmethod
	def Print(TLC: TopOpeBRep_TypeLineCurve) -> Tuple[Standard_OStream, Standard_OStream]: ...
...
class TopOpeBRep_LineInter:
	...
	def DumpLineTransitions(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
...
class TopOpeBRep_ShapeScanner:
	...
	def DumpCurrent(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
	def Index(self) -> int: ...
	@overload
...
class TopOpeBRep_VPointInter:
	...
	@overload
	def Dump(self, I: int, F: TopoDS_Face) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	def Dump(self, F1: TopoDS_Face, F2: TopoDS_Face) -> Tuple[Standard_OStream, Standard_OStream]: ...
	def Edge(self, I: int) -> TopoDS_Shape: ...
	@overload
