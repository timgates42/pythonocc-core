...
class tnaming:
	...
	@overload
	@staticmethod
	def Print(EVOL: TNaming_Evolution) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(NAME: TNaming_NameType) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(ACCESS: TDF_Label) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
