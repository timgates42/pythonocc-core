...
") Dump;
		Standard_OStream & Dump(Standard_OStream &OutValue, const Standard_Boolean deep);
...
theDumpLog: Standard_OStream
") DumpShape;
		static void DumpShape(Standard_OStream &OutValue, const TDF_Label & L, const Standard_Integer level = 0, const Standard_Boolean deep = Standard_False);
