...
class TDF_Attribute(Standard_Transient):
	...
	def ExtendedDump(self, aFilter: TDF_IDFilter, aMap: TDF_AttributeIndexedMap) -> Standard_OStream: ...
	@overload
...
class TDF_Label:
	...
	def Depth(self) -> int: ...
	def Dump(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
	def EntryDump(self) -> Standard_OStream: ...
	def ExtendedDump(self, aFilter: TDF_IDFilter, aMap: TDF_AttributeIndexedMap) -> Standard_OStream: ...
...
class TDF_RelocationTable(Standard_Transient):
	...
	def Clear(self) -> None: ...
	def Dump(self, dumpLabels: bool, dumpAttributes: bool, dumpTransients: bool) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
...
class TDF_Tool:
	...
	@overload
	@staticmethod
	def DeepDump(aDF: TDF_Data) -> Standard_OStream: ...
	@overload
	@staticmethod
	def DeepDump(aLabel: TDF_Label) -> Standard_OStream: ...
	@staticmethod
	def Entry(aLabel: TDF_Label, anEntry: TCollection_AsciiString) -> None: ...
	@overload
	@staticmethod
	def ExtendedDeepDump(aDF: TDF_Data, aFilter: TDF_IDFilter) -> Standard_OStream: ...
	@overload
	@staticmethod
	def ExtendedDeepDump(aLabel: TDF_Label, aFilter: TDF_IDFilter) -> Standard_OStream: ...
	@overload
	@staticmethod
