...
") CommentWriter;
		static Standard_OStream & CommentWriter(const char * aComment, Standard_OStream &OutValue);

		/****************** VrmlHeaderWriter ******************/
		/**** md5 signature: e0e105d95fec65a919874d86d7edc262 ****/
		%feature("compactdefaultargs") VrmlHeaderWriter;
		%feature("autodoc", "Writes a header in anostream (vrml file). writes one line of commentary in anostream (vrml file).
...
anOStream: Standard_OStream
") VrmlHeaderWriter;
		static Standard_OStream & VrmlHeaderWriter(Standard_OStream &OutValue);
...
") Vrml_Instancing;
		...
		%feature("autodoc", "Adds 'use <myname>' in anostream (vrml file).
...
anOStream: Standard_OStream
") DEF;
		Standard_OStream & DEF(Standard_OStream &OutValue);
...
anOStream: Standard_OStream
") USE;
		Standard_OStream & USE(Standard_OStream &OutValue);
