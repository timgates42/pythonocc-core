...
class TopOpeBRepBuild_GTopo:
	...
	def Dump(self, s: Optional[None] = None) -> Standard_OStream: ...
	@staticmethod
	def DumpSSB(s1: TopAbs_State, s2: TopAbs_State, b: bool) -> Standard_OStream: ...
	def DumpType(self) -> Standard_OStream: ...
	def DumpVal(self, s1: TopAbs_State, s2: TopAbs_State) -> Standard_OStream: ...
...
class TopOpeBRepBuild_ShapeSet:
	...
	def DumpCheck(self, str: TCollection_AsciiString, S: TopoDS_Shape, chk: bool) -> Standard_OStream: ...
	def DumpName(self, str: TCollection_AsciiString) -> Standard_OStream: ...
