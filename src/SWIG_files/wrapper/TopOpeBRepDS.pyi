...
class topopebrepds:
	...
	@overload
	@staticmethod
	def Print(S: TopAbs_State) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(K: TopOpeBRepDS_Kind) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(K: TopOpeBRepDS_Kind, I: int, B: Optional[TCollection_AsciiString] = "", A: Optional[TCollection_AsciiString] = "") -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(T: TopAbs_ShapeEnum, I: int) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(C: TopOpeBRepDS_Config) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
...
class TopOpeBRepDS_Check(Standard_Transient):
	...
	def Print(self, stat: TopOpeBRepDS_CheckStatus) -> Tuple[Standard_OStream, Standard_OStream]: ...
	def PrintIntg(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	def PrintShape(self, SE: TopAbs_ShapeEnum) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	def PrintShape(self, index: int) -> Tuple[Standard_OStream, Standard_OStream]: ...
