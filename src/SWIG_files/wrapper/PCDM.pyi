...
class pcdm:
	...
	@overload
	@staticmethod
	def FileDriverType(theIStream: Standard_IStream, theBaseDriver: PCDM_BaseDriverPointer) -> PCDM_TypeOfFileDriver: ...
...
class PCDM_ReadWriter(Standard_Transient):
	...
	@overload
	@staticmethod
	def FileFormat(theIStream: Standard_IStream, theData: Storage_Data) -> TCollection_ExtendedString: ...
	@staticmethod
...
class PCDM_Reader(Standard_Transient):
	...
	@overload
	def Read(self, theIStream: Standard_IStream, theStorageData: Storage_Data, theDoc: CDM_Document, theApplication: CDM_Application) -> None: ...
...
class PCDM_Writer(Standard_Transient):
	...
	@overload
	def Write(self, theDocument: CDM_Document) -> Standard_OStream: ...
