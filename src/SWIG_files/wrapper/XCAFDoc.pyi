...
class XCAFDoc_ShapeTool(TDF_Attribute):
	...
	@overload
	def Dump(self, deep: bool) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	def Dump(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@staticmethod
	def DumpShape(L: TDF_Label, level: Optional[int] = 0, deep: Optional[bool] = False) -> Standard_OStream: ...
