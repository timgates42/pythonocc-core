...
S: Standard_OStream
") Print;
		static Standard_OStream & Print(const TDataXtd_GeometryEnum GEO, Standard_OStream &OutValue);
...
S: Standard_OStream
") Print;
		static Standard_OStream & Print(const TDataXtd_ConstraintEnum CTR, Standard_OStream &OutValue);
