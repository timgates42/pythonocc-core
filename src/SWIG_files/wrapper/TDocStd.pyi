...
class TDocStd_Application(CDF_Application):
	...
	@overload
	def Open(self, theIStream: Standard_IStream, theDoc: TDocStd_Document) -> PCDM_ReaderStatus: ...
	...
	@overload
	def SaveAs(self, theDoc: TDocStd_Document) -> Tuple[PCDM_StoreStatus, Standard_OStream]: ...
	@overload
	...
	@overload
	def SaveAs(self, theDoc: TDocStd_Document, theStatusMessage: TCollection_ExtendedString) -> Tuple[PCDM_StoreStatus, Standard_OStream]: ...
...
class TDocStd_MultiTransactionManager(Standard_Transient):
	...
	def DumpTransaction(self) -> Standard_OStream: ...
