...
class vrml:
	@staticmethod
	def CommentWriter(aComment: str) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@staticmethod
	def VrmlHeaderWriter() -> Tuple[Standard_OStream, Standard_OStream]: ...
...
class Vrml_AsciiText(Standard_Transient):
	...
	def Print(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
...
class Vrml_Instancing:
	...
	def DEF(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
	def USE(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
