...
class topabs:
	...
	@overload
	@staticmethod
	def Print(theShapeType: TopAbs_ShapeEnum) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(theOrientation: TopAbs_Orientation) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(St: TopAbs_State) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@staticmethod
