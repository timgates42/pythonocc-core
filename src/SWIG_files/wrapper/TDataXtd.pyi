...
class tdataxtd:
	...
	@overload
	@staticmethod
	def Print(GEO: TDataXtd_GeometryEnum) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	@staticmethod
	def Print(CTR: TDataXtd_ConstraintEnum) -> Tuple[Standard_OStream, Standard_OStream]: ...
