...
class TopTools_ShapeSet:
	...
	def Dump(self) -> Standard_OStream: ...
	@overload
	def Dump(self, S: TopoDS_Shape) -> Standard_OStream: ...
	@overload
	def DumpExtent(self) -> Tuple[Standard_OStream, Standard_OStream]: ...
	@overload
	...
	def Read(self, IS: Standard_IStream) -> None: ...
	@overload
	def Read(self, S: TopoDS_Shape, IS: Standard_IStream) -> None: ...
	@overload
