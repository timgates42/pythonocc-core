...
class poly:
	...
	@overload
	@staticmethod
	def Dump(T: Poly_Triangulation) -> Standard_OStream: ...
	@overload
	@staticmethod
	def Dump(P: Poly_Polygon3D) -> Standard_OStream: ...
	@overload
	@staticmethod
	def Dump(P: Poly_Polygon2D) -> Standard_OStream: ...
	@staticmethod
	def PointOnTriangle(P1: gp_XY, P2: gp_XY, P3: gp_XY, P: gp_XY, UV: gp_XY) -> float: ...
	@staticmethod
	def ReadPolygon2D(IS: Standard_IStream) -> Poly_Polygon2D: ...
	@staticmethod
	def ReadPolygon3D(IS: Standard_IStream) -> Poly_Polygon3D: ...
	@staticmethod
	def ReadTriangulation(IS: Standard_IStream) -> Poly_Triangulation: ...
	@overload
	@staticmethod
	def Write(T: Poly_Triangulation, Compact: Optional[bool] = True) -> Standard_OStream: ...
	@overload
	@staticmethod
	def Write(P: Poly_Polygon3D, Compact: Optional[bool] = True) -> Standard_OStream: ...
	@overload
	@staticmethod
	def Write(P: Poly_Polygon2D, Compact: Optional[bool] = True) -> Standard_OStream: ...
...
poly_ReadPolygon2D = poly.ReadPolygon2D
poly_ReadPolygon3D = poly.ReadPolygon3D
poly_ReadTriangulation = poly.ReadTriangulation
